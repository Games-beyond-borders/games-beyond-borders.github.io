...
shareableImages.forEach(image => {
  image.addEventListener('contextmenu', event => {
    ...
    menu.innerHTML = `
      <a href="#" onclick="copyUrl(event, 'https://games-beyond-borders.github.io/templates/mods/index.html?query=${encodeURIComponent(image.alt)}');">คัดลอกลิงก์ม็อด</a>
      <a href="#" onclick="shareByEmail(event, 'https://games-beyond-borders.github.io/templates/mods/index.html?query=${encodeURIComponent(image.alt)}', '${encodeURIComponent(image.alt)}');">แบ่งปันทางอีเมล</a>
      <a href="#" onclick="shareOnFacebook(event, 'https://games-beyond-borders.github.io/templates/mods/index.html?query=${encodeURIComponent(image.alt)}', '${encodeURIComponent(image.alt)}');">แชร์บน Facebook</a>
      <a href="#" onclick="shareOnTwitter(event, 'https://games-beyond-borders.github.io/templates/mods/index.html?query=${encodeURIComponent(image.alt)}', '${encodeURIComponent(image.alt)}');">แชร์บนทวิตเตอร์</a>
    `;
